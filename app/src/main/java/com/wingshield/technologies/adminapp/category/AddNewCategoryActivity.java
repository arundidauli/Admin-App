...
public class AddNewCategoryActivity extends AppCompatActivity {
    ...
    private static String TAG = AddNewCategoryActivity.class.getSimpleName();
    @BindView(R.id.category_image)
    ImageView product_category_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = AddNewCategoryActivity.this;
    ...
    void initView() {
        ...
        TextInputEditText et_product_category_name = findViewById(R.id.et_product_category_name);
        product_category_img.setOnClickListener(view -> {
            permissions();
        });

        Button btn_save = findViewById(R.id.btn_save);
        btn_save.setOnClickListener(view -> {
            if (TextUtils.isEmpty(et_product_category_name.getText().toString())) {
                et_product_category_name.setError("Field id empty!");
                et_product_category_name.requestFocus();
            } else {
                saveCategory(et_product_category_name.getText().toString());
            }
    ...
    private void launchCameraIntent() {
        Intent intent = new Intent(AddNewCategoryActivity.this, ImagePickerActivity.class);
    ...
    private void loadProfile(String url, Bitmap bitmap) {
        ...
        Glide.with(this).load(url)
                .into(product_category_img);
        product_category_img.setColorFilter(ContextCompat.getColor(this, android.R.color.transparent));
    ...
    private void loadProfileDefault() {
        Glide.with(this).load(R.mipmap.user)
                .into(product_category_img);
        product_category_img.setColorFilter(ContextCompat.getColor(this, R.color.colorAccent));
    }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Glide.with(context).load(uri.toString()).thumbnail(0.1f).into(product_category_img);
    ...
    private void saveCategory(String category_name) {
        String id = mDatabaseReference.child("productCategory").push().getKey();
        ProductCategory product = new ProductCategory();
        product.setCategory_id(id);
        product.setCategory_name(category_name);
        product.setCategory_image(IMAGE_URL);
        mDatabaseReference.child("productCategory").child(Objects.requireNonNull(id)).setValue(product);
        Toast.makeText(getApplicationContext(), "Category Add successfully", Toast.LENGTH_LONG).show();
